...
class StockService:
    ...
    def make_filter_by_symbol_and_add_annotate(self, qs, symbol, start, end):
        ...
        queryset_filter = self.filter_queryset_by_timestamp(queryset_exists, start, end)
        queryset_exists_after_filter = validate_queryset_after_filters(queryset_filter)
